...
public class test {
	...
	public static void main(String[] args) {
		...
		// Instruction récupérant le modèle sous forme d'arbre à partir de la
		// classe racine "map"
		...
		for (int j = 0; j < maMap.getRoads().size(); j++) {			
			System.out.println(maMap.getRoads().get(j).);
		}
		
		System.out.println("\n Rues pietonnes de plus de 1000m");
