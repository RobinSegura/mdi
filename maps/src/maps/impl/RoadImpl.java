...
public abstract class RoadImpl extends MinimalEObjectImpl.Container implements Road {
	...
	public EList getBorder() {
		if (border == null) {
			border = new EObjectWithInverseResolvingEList.ManyInverse(PublicSpace.class, this, MapsPackage.ROAD__BORDER, MapsPackage.PUBLIC_SPACE__BORDERED_BY);
		}
		return border;
	}
	 ...
	 * @generated
	 */
	public EList getMeet() {
		if (meet == null) {
			meet = new EObjectResolvingEList(Road.class, this, MapsPackage.ROAD__MEET);
		}
		return meet;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MapsPackage.ROAD__BORDER:
				return ((InternalEList)getBorder()).basicAdd(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case MapsPackage.ROAD__BORDER:
				getBorder().clear();
				getBorder().addAll((Collection)newValue);
				return;
			case MapsPackage.ROAD__NAME:
			...
			case MapsPackage.ROAD__MEET:
				getMeet().clear();
				getMeet().addAll((Collection)newValue);
				return;
		}
